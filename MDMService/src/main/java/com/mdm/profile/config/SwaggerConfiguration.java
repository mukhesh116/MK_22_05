package com.mdm.profile.config;
...
public class SwaggerConfiguration {
    ...
    public Docket productApi() {
        return new Docket(DocumentationType.SWAGGER_2).groupName("MDM Profile Service").apiInfo(apiInfo()).select()
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder().title("BlockBone Company Profile Service Micro Service").description(
				...
				.contact("Mukesh").license("Apache License Version 2.0").version("1.1.0").build();
	}
}
